...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-pattern flex">
      {/* Left panel */}
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-slate-900 via-primary-700 to-primary-500 relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-16">
            ...
            <span className="font-display text-white text-2xl font-bold">TripNest</span>
          </div>
        ...
        <div className="relative z-10 grid grid-cols-2 gap-4">
          {[
            ...
            <div key={f.label} className="bg-white/10 backdrop-blur-sm rounded-xl p-4 flex items-center gap-3">
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md animate-slide-up">
          <div className="lg:hidden flex items-center gap-2 mb-8">
            ...
            <span className="font-display text-primary-600 text-xl font-bold">TripNest</span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="relative">
              <Mail size={16} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-primary-400 pointer-events-none" />
              <input
            ...
            <div className="relative">
              <Lock size={16} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-primary-400 pointer-events-none" />
              <input
